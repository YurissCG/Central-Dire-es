Banco de imagens público, camada 1 (temporária), conforme `docs/09-imagens-e-midia.md`.

Todo arquivo aqui é temporário e sai quando as fotos oficiais da oficina chegarem, ver seção 9.10 do doc 09.

| Arquivo | Fonte | Autor | Link | Baixado em |
|---|---|---|---|---|
