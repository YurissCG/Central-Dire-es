export const SERVICOS = [
  {
    ...
    prioridade: 1,
    processo: [
      "Teste de pressão do sistema e inspeção de vazamento",
      "Verificação do fluido e da correia",
      "Diagnóstico do componente responsável: bomba, caixa, mangueira ou reservatório",
      "Orçamento antes de qualquer desmontagem",
      "Reparo ou substituição por peça remanufaturada",
  ...
  },
  {
    ...
    prioridade: 2,
    processo: [
      "Inspeção de folga em caixa, terminal, barra axial e pivô",
      "Teste de direção em movimento",
  ...
  },
  {
    ...
    prioridade: 2,
    processo: [
      "Inspeção visual com o carro suspenso",
      "Teste de amortecedor e verificação de vazamento",
      "Checagem de bucha, coxim, pivô e bandeja",
  ...
  },
  {
    ...
    prioridade: 1,
    processo: [
      "Conferência de calibragem e estado do pneu",
      "Inspeção de folga antes de alinhar, porque alinhar com folga não resolve",
      "Alinhamento de cambagem, cáster e convergência",
  ...
  },
  {
    ...
    prioridade: 3,
    processo: [
      "Medição de pastilha e de disco",
      "Verificação de fluido e de vazamento",
  ...
  },
  {
    ...
    prioridade: 3,
    processo: [
      "Checklist de direção, suspensão e freio",
      "Conferência de pneu, calibragem e estepe",
...
export type ServicoSlug = Servico["slug"];
